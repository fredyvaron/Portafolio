...
import Ryckmorty from "../assets/Capture_rick_and_morty.png";
import Country from "../assets/capture_app_country.png";
    ...
    <div name="proyectos">
      <section className="bg-white dark:bg-gray-900 mx-auto">
        <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6 ">
          ...
          <div className="grid gap-8 mb-6 m-auto lg:mb-8 md:grid-cols-3 items-center place-items-center">
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 hover:bg-gray-100 shadow-md  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <div className="p-5">
                ...
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
                    <a
                      href="https://github.com/fredyvaron/RickAndMorty"
                      target={"_blank"}
                  ...
                  <li>
                    <a
                      href="https://rick-and-morty-self-eight.vercel.app/"
                      target={"_blank"}
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
            ...
            <div className="max-w-sm  bg-white rounded-lg border border-gray-200 hover:bg-gray-100 shadow-md dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-justify">
                  la tematica de este proyecto ordenar y filtrar los datos
                  traidos de una api y crear diferentes tipos de actividades
                  para cada paises.
                </p>
                ...
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
                    <a
                      href="https://github.com/fredyvaron/PI-Countries-main"
                      target={"_blank"}
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                    >
                      <svg
            ...
            <div className="max-w-sm  bg-white rounded-lg border border-gray-200 hover:bg-gray-100 shadow-md dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <div className="p-5">
                ...
                <span className="text-gray-500 dark:text-gray-400">
                  Node, Express, Sequalize, SendGrid
                </span>
